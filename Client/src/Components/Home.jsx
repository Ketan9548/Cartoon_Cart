      ...
      <div className="bg-cyan-50 h-screen grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="col-span-2 flex justify-center mt-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-3xl">
            <p className="hover:text-light-green-700">
              <NavLink to="#">Ben10</NavLink>
            </p>
            <p className="hover:text-cyan-600">
              <NavLink to="#">Doraemon</NavLink>
            </p>
            <p className="hover:text-deep-orange-700">
              <NavLink to="#">Naruto</NavLink>
            </p>
            <p className="hover:text-orange-600">
              <NavLink to="#">Tom & Jerry</NavLink>
            </p>
          </div>
        </div>
      </div>
      <div className="border-2 border-light-blue-100">
        <Information />
      </div>
    </>
  );
